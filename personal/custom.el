...
(custom-set-faces
 ...
 '(org-done ((t (:foreground "green yellow" :weight bold :height 1.1))) t)
 '(org-level-1 ((t (:foreground "yellow" :weight bold :height 1.2))) t)
 '(org-level-3 ((t (:foreground "#93D0E3"))) t)
 '(org-level-5 ((t (:foreground "indian red"))) t)
 '(org-level-6 ((t (:foreground "steel blue"))) t)
 '(org-level-7 ((t (:inherit outline-7 :foreground "brown"))) t)
 '(org-scheduled-previously ((t (:foreground "DarkGoldenrod1"))) t)
